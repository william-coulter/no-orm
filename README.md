...
Build your Typescript server code without learning an ORM abstraction!
...
- Tables with [Composite Type](https://www.postgresql.org/docs/current/rowtypes.html) columns.
