...
await pool.connect(async (connection) => {
  ...
  const update = await Tables.TestTypeParsing.update({
    ...
    newRow: {
      ...
      a_enum_nullable: "another_value",
      a_text_short: parseTextShortDomain("another_text_short"),
      a_text_short_nullable: parseTextShortDomain("another_text_short"),
      a_float_range: Ranges.Schemas.floatRange.parse("[2.0,5.0)"),
      a_float_range_nullable: Ranges.Schemas.floatRange.parse("[2.0,5.0)"),
